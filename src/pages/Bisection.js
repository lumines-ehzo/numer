        ...
        <Row >
          <Col >
            <Card title="Bisection" bordered={false}>
              <form>
                <p>Input Equal</p>
                <Input type="text" name ="text" placeholder="EX: 2x+1" id="text1"/>
                <br />
                <br />
                <p>Number Start (XL)</p>
                <Input type="text" name ="text" placeholder="3" id="text2" />
                <br />
                <br />
                <p>Numer End (XR)</p>
                <Input type="text" name ="text" placeholder="5" id="text3" />
                <br />
                <br />
              </form>
              <center>
                <Button type="primary" onClick={this.bisec}>
                  SUBMIT
                </Button>
                &nbsp;&nbsp;
                <br />
